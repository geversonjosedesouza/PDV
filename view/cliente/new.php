...
<div class="col-lg-6 jumbotron">
    <form action="<?php echo server_url('?page=ControllerCliente&option=salvar'); ?>" method="post">
        ...
        <br>
        <label>CPF:</label>
        <input type="text" name="clie_cpf" id="cpf" placeholder="Digite o CPF" class="form-control" required>
        <br>
        <label>Endereço:</label>
        <input type="text" name="clie_endereco" placeholder="Digite o endereço" class="form-control" required>
        <br>
        <label>Telefone:</label>
        <input type="tel" name="clie_telefone" id="telefone" placeholder="Digite o telefone" class="form-control" required>
        <br>
