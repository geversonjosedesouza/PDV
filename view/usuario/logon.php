...
<ul class="nav navbar-nav">
    <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#"><?php echo $us->user; ?><span class="glyphicon glyphicon-user"></span></a>
        <ul class="dropdown-menu">    
            ...
            <li><a href="<?php echo server_url("?page=ControllerUsuario&option=editaProfile&user=" . $us->user); ?>" class="btn btn-default btn-xs"> <span class="glyphicon glyphicon-user"></span>Perfil</a></li>
